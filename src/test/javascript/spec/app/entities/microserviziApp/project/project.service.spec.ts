...
import { ProjectService } from 'app/entities/microserviziApp/project/project.service';
    ...
    describe('Project Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Project', () => {
                service.create(new Project(null)).subscribe(received => {
            ...
            it('should update a Project', () => {
                service.update(new Project(123)).subscribe(received => {
