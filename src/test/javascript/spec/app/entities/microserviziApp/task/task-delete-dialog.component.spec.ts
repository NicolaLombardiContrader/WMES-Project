...
import { TaskDeleteDialogComponent } from 'app/entities/microserviziApp/task/task-delete-dialog.component';
import { TaskService } from 'app/entities/microserviziApp/task/task.service';
