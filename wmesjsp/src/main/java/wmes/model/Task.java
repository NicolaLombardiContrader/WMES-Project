...
public class Task {
	...
	public Task(User user, String taskDescription, String taskAction, String taskInput, String taskOutput,
			String taskResource, int tasktime, int taskState) {
		this.user = user;
	...
	public String toString() {
		return this.getTaskId() + "\t " + this.getUser() + "\t" + this.getTaskDescription() + "\t"
				+ this.getTaskAction() + "\t" + this.getTaskInput() + "\t" + this.getTaskOutput() + "\t"
				+ this.getTaskResource() + "\t" + this.getTaskTime() + "\t" + this.getTaskState();
