...
<%
	...
	ResourceDTO resourceDTO = (ResourceDTO) request.getAttribute("resourceDTO");
%>
<%!private String printTaskStateMenu(int taskIdSelected, TaskDTO updateTaskMenu) {
		String selected = "selected=\"selected\"";
		String taskMenu = "<select class=\"form-control\" name=\"task_state\">";
		if (updateTaskMenu.getTaskState() == 0) {
			taskMenu += "<option " + selected + " value=\"" + updateTaskMenu.getTaskState() + "\">Pending</option>";
		} else {
			taskMenu += "<option value=\"0\">Pending</option>";
		}

		if (updateTaskMenu.getTaskState() == 1) {
			taskMenu += "<option " + selected + " value=\"" + updateTaskMenu.getTaskState() + "\">Progress</option>";
		} else {
			taskMenu += "<option value=\"1\">Progress</option>";
		}

		if (updateTaskMenu.getTaskState() == 2) {
			taskMenu += "<option " + selected + " value=\"" + updateTaskMenu.getTaskState() + "\">Completed</option>";
		} else {
			taskMenu += "<option value=\"2\">Completed</option>";
		}

		return taskMenu += "</select>";
	}%>
