...
<%
	ResourceDTO updateResource = (ResourceDTO) request.getAttribute("resourceUpdate");
%>
	...
	<div class="page-wrapper">
		...
		<div class="page-container2">
								...
								<div class="au-breadcrumb-content">
									<div class="au-breadcrumb-left">
										...
										<ul class="list-unstyled list-inline au-breadcrumb__list">
											...
											<li class="list-inline-item">Edit Resource</li>
										</ul>
									</div>
								</div>
							</div>
			...
			<section>
				...
				<input type="hidden" name="resource_id" value="<%=updateResource.getResourceId()%>" />
					<div class="form-group">
						<label>Name</label> <input class="au-input au-input--full" type="text" name="resource_name" placeholder="name" value="<%=updateResource.getResourceName()%>">
					</div>
					<div class="form-group">
						<label>Username</label> <input class="au-input au-input--full" type="text" name="resource_username" placeholder="Username" value="<%=updateResource.getResourceUsername()%>">
					</div>
					<div class="form-group">
						<label>Password</label> <input class="au-input au-input--full" type="text" name="resource_pass" placeholder="Password" value="<%=updateResource.getResourcePass()%>">
					</div>
