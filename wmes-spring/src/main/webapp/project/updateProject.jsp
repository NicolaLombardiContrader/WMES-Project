	...
	<div class="page-wrapper">
		...
		<div class="page-container2">
								...
								<div class="au-breadcrumb-content">
									<div class="au-breadcrumb-left">
										...
										<ul class="list-unstyled list-inline au-breadcrumb__list">
											...
											<li class="list-inline-item">Edit Project</li>
										</ul>
									</div>
								</div>
							</div>
			...
			<section>
				...
				<input type="hidden" name="project_id" value="<%=updateProject.getProjectId()%>" />
				
					<div class="form-group">
						<label>Name</label> <input class="au-input au-input--full" type="text" name="project_name" placeholder="Name" value="<%=updateProject.getProjectName()%>">
					</div>
