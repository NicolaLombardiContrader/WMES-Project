                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <label>Action</label>
                                    <input class="au-input au-input--full" type="text" name="action" placeholder="Action">
                                </div>
                                <div class="form-group">
                                    <label>Input</label>
                                    <input class="au-input au-input--full" type="text" name="input" placeholder="Input">
                                </div>
                                <div class="form-group">
                                    <label>Output</label>
                                    <input class="au-input au-input--full" type="text" name="output" placeholder="Output">
                                </div>
                                <div class="form-group">
                                    <label>Resource</label>
                                    <input class="au-input au-input--full" type="text" name="resource" placeholder="Resource">
                                </div>
                                <div class="form-group">
                                    <label>Time</label>
                                    <input class="au-input au-input--full" type="text" name="time" placeholder="Time">
                                </div>
                                <div class="form-group">
                                    <label>State</label>
                                    <input class="au-input au-input--full" type="text" name="state" placeholder="State">
                                </div>
