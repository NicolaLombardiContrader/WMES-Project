...
--
-- Table structure for table `projects_templates_wbs`
--

DROP TABLE IF EXISTS `projects_templates_wbs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `projects_templates_wbs` (
  `task_template_id_child` int(11) NOT NULL,
  `task_template_id_father` int(11) NOT NULL,
  KEY `FKea4lc6hgh66wc062l55duiddp` (`task_template_id_father`),
  KEY `FKp35lc6136eje5dcg0v3iwr95n` (`task_template_id_child`),
  CONSTRAINT `FKea4lc6hgh66wc062l55duiddp` FOREIGN KEY (`task_template_id_father`) REFERENCES `tasks_template` (`task_id`) ON DELETE CASCADE,
  CONSTRAINT `FKp35lc6136eje5dcg0v3iwr95n` FOREIGN KEY (`task_template_id_child`) REFERENCES `tasks_template` (`task_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projects_templates_wbs`
--

LOCK TABLES `projects_templates_wbs` WRITE;
/*!40000 ALTER TABLE `projects_templates_wbs` DISABLE KEYS */;
/*!40000 ALTER TABLE `projects_templates_wbs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projects_wbs`
--

DROP TABLE IF EXISTS `projects_wbs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `projects_wbs` (
  `task_id_child` int(11) NOT NULL,
  `task_id_father` int(11) NOT NULL,
  KEY `FKiq4fh7ctcv5qc8n3l0vj5pkdi` (`task_id_father`),
  KEY `FK64s2qdav09uit44kxfl44h7sv` (`task_id_child`),
  CONSTRAINT `FK64s2qdav09uit44kxfl44h7sv` FOREIGN KEY (`task_id_child`) REFERENCES `tasks` (`task_id`),
  CONSTRAINT `FKiq4fh7ctcv5qc8n3l0vj5pkdi` FOREIGN KEY (`task_id_father`) REFERENCES `tasks` (`task_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projects_wbs`
--

LOCK TABLES `projects_wbs` WRITE;
/*!40000 ALTER TABLE `projects_wbs` DISABLE KEYS */;
/*!40000 ALTER TABLE `projects_wbs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tasks_template_items` (
  ...
  CONSTRAINT `FKhqcjwg8ah6sk583lf8pv07b33` FOREIGN KEY (`task_id`) REFERENCES `tasks_template` (`task_id`),
...
INSERT INTO `users` VALUES (1,'admin','admin','admin'),(2,'user','user','bo');
...
-- Dump completed on 2019-03-15 12:37:17
