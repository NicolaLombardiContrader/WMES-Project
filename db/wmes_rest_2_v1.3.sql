...
CREATE TABLE `projects_templates_wbs` (
  ...
  CONSTRAINT `FKea4lc6hgh66wc062l55duiddp` FOREIGN KEY (`task_template_id_father`) REFERENCES `tasks_template` (`task_template_id`) ON DELETE CASCADE,
  CONSTRAINT `FKp35lc6136eje5dcg0v3iwr95n` FOREIGN KEY (`task_template_id_child`) REFERENCES `tasks_template` (`task_template_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-03-15 14:43:52
